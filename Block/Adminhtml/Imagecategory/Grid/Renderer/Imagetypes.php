...
namespace Magebay\Pdc\Block\Adminhtml\Imagecategory\Grid\Renderer;

class Imagetypes extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        if ($category && $category->getId()) {
            return $category->getImagetypeAsLabel();
        }

...
class Edit extends \Magebay\Pdc\Controller\Adminhtml\Image
{
    /**
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Magebay\Pdc\Model\Image');
        ...
        $this->_coreRegistry->register('pdc_image', $model);
